      ...
      <div>
        {bizData.map((biz, index) => (
          <ul id="location-cell">
            ...
            <img
              id="location-png"
              src="https://img.pngio.com/address-logo-png-105-images-in-collection-page-2-address-logo-png-730_980.png"
            />{" "}
            {biz.Address} <br />
            <img
              id="location-png"
              src="https://simpleicon.com/wp-content/uploads/building-3.png"
            />{" "}
            {biz.Type} <br />
            Availability:
            <select id="days">
            ...
            <img
              id="location-png"
              src="https://www.pngrepo.com/download/100889/yen-currency-symbol.png"
            />{" "}
            {biz.Price} <br />
