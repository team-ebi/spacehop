...
const getSingleObject = (bucket, bucketName, key) => {
  return new Promise((resolve, reject) => {
...
module.exports = { listObjects, getSingleObject, saveObject, deleteObjects };

// // Get images by users_id (business table has users_id)
